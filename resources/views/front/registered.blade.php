...
<div class="form-bak" id="app">
    ...
    <form method="post" action="#" onsubmit="adaptValue();">
        ...
        <div class="left">
            ...
            <div class="line" id="line_account">
                ...
                <div class="input">
                    ...
                    <input type="text" name="account" ref="email" id="account" onblur="v_account();" onkeyup="v_account();"/>
            ...
            <div class="line" id="line_name">
                ...
                <div class="input">
                    ...
                    <input type="text" name="name" ref="name" id="name" onblur="v_name();" onkeyup="v_name();" />
            ...
            <div class="line" id="line_password">
                ...
                <div class="input">
                    ...
                    <input type="password" name="password" ref="password" id="password" onblur="v_password();" onkeyup="v_password();" />
        ...
        <div class="right">
            ...
            <input type="button" id="submit" value="完成注册"  @click="submitForm"/>
    ...
    Vue.config.devtools = true;
        new Vue({
            ...
            methods:{
                submitForm:function () {
                    axios
                        .post('http://www.larxwc.com/api/register',{
