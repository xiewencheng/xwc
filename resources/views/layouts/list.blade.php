...
<!-- 左侧菜单开始 -->
@foreach($data as $k => $v)
    @foreach($v['childss'] as $key => $vv)
        @foreach($vv['childss'] as $key => $vvv)
            @foreach($vvv['childss'] as $key => $vvvv)
                @foreach($vvvv['childss'] as $key => $vvvvv)
                    @foreach($vvvvv['childss'] as $key => $vvvvvv)
<div class="left-nav">
    <div id="side-nav">
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('文章列表','{{$v->ca}}')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>文章列表</cite></a>
                    </li>
                </ul>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('多级分类','{{$vvvv->ca}}')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>多级分类</cite></a>
                    </li>
                </ul>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('评论管理','comments')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>评论管理</cite></a>
                    </li>
                </ul>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('管理员列表','{{$vv->ca}}')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>管理员列表</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('角色管理','{{$vvv->ca}}')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>角色管理</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('权限分类','{{$vvvvv->ca}}')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>权限分类</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('权限管理','{{$vvvvvv->ca}}')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>权限管理</cite></a>
                    </li>
                </ul>
